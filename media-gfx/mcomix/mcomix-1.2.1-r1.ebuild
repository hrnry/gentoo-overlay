...
src_prepare() {
	...
	# [mcomix] Python2-pillow 6.0 breaks the program - https://bugs.archlinux.org/task/62242
	[[ $(python2.7 -c "import PIL.Image; print(PIL.Image.__version__)" &>/dev/null; echo $?) -eq 0 ]] \
		&& epatch "${FILESDIR}/1.2.1-r1_pillow6.patch"
}
